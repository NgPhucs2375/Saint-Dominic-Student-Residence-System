...
export default function Header() {
  ...
  return (
    <header style={{ 
      height: 96, borderBottom: `1px solid ${C.border}`, 
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
        <div style={{ 
          ...
          padding: "12px 24px", width: 340, boxShadow: "0 2px 10px rgba(0,0,0,0.02)", 
          transition: "all 0.3s cubic-bezier(0.25, 1, 0.5, 1)" 
        }}
          onFocus={e => { e.currentTarget.style.borderColor = C.gold; e.currentTarget.style.boxShadow = "0 8px 24px rgba(181, 150, 90, 0.15)"; }}
        ...
        <button style={{ 
          background: C.card, border: `1px solid ${C.border}`, width: 48, height: 48, 
          borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", 
          color: C.text, cursor: "pointer", position: "relative", transition: "transform 0.2s, box-shadow 0.2s" 
        }}
        onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(0,0,0,0.05)"; }}
